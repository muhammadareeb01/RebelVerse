            ...
            >
              ...
              >
                <div className="relative">
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-r from-orange-500 to-pink-500 rounded-xl blur-lg opacity-50"
                    animate={{ scale: [1, 1.2, 1] }}
                    transition={{ duration: 2, repeat: Infinity }}
                  />
                  <div className="relative bg-gradient-to-r from-orange-500 to-pink-500 p-3 rounded-xl">
                    <Rocket className="w-8 h-8 text-white" />
                  </div>
                </div>
                <div>
                  <h3 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-400 via-pink-400 to-purple-400">
                    RebelVerse
                  </h3>
              ...
              <p className="text-gray-400 leading-relaxed mb-6 max-w-md">
                ...
                - Where innovation meets excellence. We transform ideas into
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <motion.li
                    ...
                    transition={{ duration: 0.2 }}
                  >
                    <span className="text-gray-400 hover:text-purple-400 transition-colors flex items-center gap-2 group cursor-pointer">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8">
            ...
            >
              <p className="text-gray-400 text-sm flex items-center gap-2 flex-wrap justify-center md:justify-start">
                <span>
                  &copy; {currentYear} RebelVerse. All rights reserved.
                </span>
        ...
        >
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Let's break the ice and start a conversation! It's like adding
              sprinkles to the cake of life - makes everything more fun!
              <span className="text-orange-400 font-semibold">
                {' '}
